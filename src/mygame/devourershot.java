...
class devourershot extends JGObject  implements MyGameValues
{
	
	devourershot(double x, double y)
	{
		...
		super("EnemyShot",true,x,y,enemyShotCollisionID,"devourershot", 5,2, -3);
