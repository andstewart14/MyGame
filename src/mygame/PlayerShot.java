...
class PlayerShot extends JGObject  implements MyGameValues
{
	
	PlayerShot(double x, double y, double xspeed, double yspeed)
	{
		...
		super("playershot",true,x,y,playerShotCollisionID,"mutashot", xspeed,yspeed, -1);
