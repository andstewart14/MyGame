...
class PlayerShot1 extends JGObject  implements MyGameValues
{
	
	PlayerShot1(double x, double y, double xspeed, double yspeed)
	{
		...
		super("playershot",true,x,y,playerShotCollisionID,"mutashot1", xspeed,yspeed, -1);
