...
class PlayerShot3 extends JGObject  implements MyGameValues
{
	
	PlayerShot3(double x, double y, double xspeed, double yspeed)
	{
		...
		super("playershot",true,x,y,playerShotCollisionID,"mutashot3", xspeed,yspeed, -1);
