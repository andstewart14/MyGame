...
class CorsairShot extends JGObject  implements MyGameValues
{
	
	CorsairShot(double x, double y)
	{
		...
		super("EnemyShot",true,x,y,enemyShotCollisionID,"corsairshot", 5,2, -1);
