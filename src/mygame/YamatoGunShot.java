...
class YamatoGunShot extends JGObject  implements MyGameValues
{
	
	YamatoGunShot(double x, double y)
	{
		...
		super("EnemyShot",true,x,y,enemyShotCollisionID,"yamatogun", 5,2, -1);
